...
<body>
	<div class="container fluid">
		<form:form action="loginControl" method="POST" modelAttribute="userLog"  id="frmLogin">
			<div class="form-row">
				<div class="col-md-3 mb-3"></div>
				<div class="col-md-6 mb-3" id="datosLogin">
					<div class="form-group" id="usuario">
				    	<form:label id="lblinputUSR" for="inputUSR" path="login"> Usuario:</form:label>
				    	<form:input type="text" class="form-control" id="inputUSR"
				    	       placeholder="Teclee su Usuario" path="login"></form:input>
				    </div>
					...
					<div class="form-group" id="password">
				    	<form:label id="lblinputPWD" for="inputPWD" path="passkey">  Contraseña:</form:label>
				    	<form:input type="password" class="form-control" id="inputPWD" 
				    	       placeholder="Teclee su Contraseña" path="passkey"></form:input>
				    </div>
				    ...
				    <div><input id="btnLogin" type="submit" class="btn btn-primary" 
...
// 		document.getElementById("userNewValidation").addEventListener("click", validateUser);
		...
		document.getElementById("frmLogin").addEventListener("submit", loginButtonCLICKEvent);
